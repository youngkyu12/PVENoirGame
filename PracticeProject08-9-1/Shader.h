...
class CTransparentWaterShader final : public CStaticObjectsShader
{
public:
	CTransparentWaterShader() = default;
	~CTransparentWaterShader() override = default;
...
class CGunSmokeBillboardShader final : public CStaticObjectsShader
{
public:
	CGunSmokeBillboardShader() = default;
	~CGunSmokeBillboardShader() override = default;
