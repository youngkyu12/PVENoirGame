    ...
    _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_PRACTICEPROJECT11, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_PRACTICEPROJECT11));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_PRACTICEPROJECT11));
