// PracticeProject11.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//

#include "stdafx.h"
#include "PracticeProject17.h"
    ...
    _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_PRACTICEPROJECT17, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_PRACTICEPROJECT17));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_PRACTICEPROJECT17));
