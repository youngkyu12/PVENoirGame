// PracticeProject06_v2.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//

#include "stdafx.h"
#include "PracticeProject06_v2.h"
    ...
    _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_PRACTICEPROJECT06V2, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_PRACTICEPROJECT06V2));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_PRACTICEPROJECT06V2));
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow, CGameFramework& gGameFramework)
{
    ...
    HWND hMainWnd = CreateWindow(szWindowClass, szTitle, dwStyle, CW_USEDEFAULT,
        CW_USEDEFAULT, rc.right - rc.left, rc.bottom - rc.top, NULL, NULL, hInstance, (LPVOID)&gGameFramework);
